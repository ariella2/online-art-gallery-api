...
SECRET_KEY = 'django-insecure-@2au5zd_3=6_u7^aan@s*-)e-@)d=gw1$*(--$=$c3&zcb@p-*'
...
INSTALLED_APPS = [
    ...
    # Your apps
    'gallery',  # Ensure your app is listed here
]
...
DATABASES = {
    'default': { 
       'ENGINE': 'django.db.backends.mysql',
        'NAME': 'art_gallery_db',  # Replace with your database name
